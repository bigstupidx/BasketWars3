...
//Map Panel
	...
	{
		//m_map_panel.gameObject.GetComponent<TweenPosition>().ResetToBeginning();
		//m_start_back_button.PlayForward();
...
#region Move Functions
	public void MoveBritainIn()
	{
		m_britain.transform.GetChild(0).localPosition = new Vector3(0,-180,0);
		m_britain.transform.GetChild(0).GetComponent<TweenAlpha>().PlayForward();
		m_map_panel.GetComponent<TweenAlpha>().PlayForward();
		//BackButtonStack.PushStack(new EventDelegate(this,"MoveBritainOut"));
	}

	public void MoveBritainOut()
	{
		m_britain.transform.GetChild(0).GetComponent<TweenAlpha>().PlayReverse();
		//BackButtonStack.PopStack();
		m_map_panel.gameObject.GetComponent<TweenPosition>().onFinishedForward.Clear();
	}
	...
	{
		m_britain.gameObject.GetComponent<TweenPosition>().PlayReverse();
		m_britain.gameObject.GetComponent<TweenPosition>().onFinishedForward.Clear();
		//MoveModeSelectIn();
	}
